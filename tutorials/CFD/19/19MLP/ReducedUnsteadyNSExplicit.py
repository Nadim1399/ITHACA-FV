...
class ReducedUnsteadyNSExplicit:
    ...
    def __init__(self, fluxMethod):
        ...
        self.N_BC = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/N_BC.npy")
        self.Nphi_u = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/Nphi_u.npy")
        self.Nphi_p = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/Nphi_p.npy")
    ...
    def _solve_consistent(self, vel):
        ...
        C_tensor = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/C_" + str((0)) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + "_t.npy")        

        Cf_tensor = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/Cf_" + str(0) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + "_t.npy")        

        Ci_tensor = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/Ci_" + str(0) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + "_t.npy")        

        RD_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/RD/RD" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        RC_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/RC/RC" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        SD_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/SD/SD" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        SC_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/SC/SC" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        W_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/W_" + str(NUmodes) + ".npy")

        BP_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/BP" +  "_" + str(NPmodes) + ".npy")

        P_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/P" + "_" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + "_" + str(NPmodes) + ".npy")

        B_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/B" + "_" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        K_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/K" + "_" + str(i) + "_" + str(NUmodes) + "_" + str(NSUPmodes) + "_" + str(NPmodes) + ".npy")

        I_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/I" + "_" + str(NUmodes) + ".npy")

        KF_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/KF" + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        DF_matrix = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/DF" + "_" + str(NUmodes) + "_" + str(NSUPmodes) + ".npy")

        cTotalTensor = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/ITHACAoutput/Matrices/cTotalTensor.npy")

        # Create and resize the solution vectors

        a_o = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/a_o_con" + ".npy")
        a_n = np.zeros(a_o.size)
        b = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/b_con" + ".npy")
        c_o = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/c_o_con" + ".npy")
        x = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/x_con" + ".npy")
        presidual = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/presidual_con" + ".npy")
        RHS = np.load("/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/RHS_con" + ".npy")
        ...
        mlp_model = tf.keras.models.load_model('./MLP/mlp_model.keras')
        x_scaler = joblib.load("./MLP/x_scaler.pkl")
        y_scaler = joblib.load("./MLP/y_scaler.pkl")
        ...
        for out_iterator in range(len(self.online_solution)):
            ...
            for i in range(int(self.N_BC) + 1):
                ...
                filename_Div = f"/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/LinSysDiv_{i}.npy"
                LinSysDiv.append(np.load(filename_Div))
                
                filename_Conv = f"/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/LinSysConv_{i}.npy"
                LinSysConv.append(np.load(filename_Conv))
 
                filename_Diff = f"/home/nrooho/ITHACA-FV/tutorials/CFD/19/19MLP/file_python/LinSysDiff_{i}.npy"
                LinSysDiff.append(np.load(filename_Diff))
            ...
            input_concat = np.concatenate((a_n.flatten(), b.flatten()), axis=0).reshape(1, -1)
            input_scaled = x_scaler.transform(input_concat)
            nut_coeffs = mlp_model.predict(input_scaled, verbose=0)[0]
            nut_coeffs = y_scaler.inverse_transform(nut_coeffs.reshape(1, -1))[0]
    ...
    def reconstruct(self, MLP_Rec):
        ...
        u_field_MLP = u_POD_matrix @ CoeffU_mat
        p_field_MLP = p_POD_matrix @ CoeffP_mat
        nut_field_MLP = nut_POD_matrix @ CoeffNut_mat

        print("u_field_LSTM", u_field_MLP.shape)
        print("p_field_LSTM", p_field_MLP.shape)
        print("nut_field_LSTM", nut_field_MLP.shape)

        np.save(os.path.join(MLP_Rec, "u_field_MLP.npy"), u_field_MLP)
        np.save(os.path.join(MLP_Rec, "p_field_MLP.npy"), p_field_MLP)
        np.save(os.path.join(MLP_Rec, "nut_field_MLP.npy"), nut_field_MLP)
