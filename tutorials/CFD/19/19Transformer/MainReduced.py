...
if all(s == shapes[0] for s in shapes):
    ...
    np.save(os.path.join(Tr_Rec, f"online_solution_{flux_method}.npy"), online_solution_array)
else:
    np.save(os.path.join(Tr_Rec, f"online_solution_{flux_method}.npy"), 
